...
def load_manifest(path):
    ...
    if manifest['feedback_policy'] not in {'category_only', 'public_diagnostics'}:
        raise Failure('input_error', 'feedback_policy must be category_only or public_diagnostics')
