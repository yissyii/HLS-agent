...
此规则替代 9-17 评测记录所使用的“整个响应恰好一个代码块”规则。历史结果保留原口径，新增通过数需要单独评测，不能把全部格式失败或截断样本直接改计为通过。2026-09-18 已按该规则重新独立采样并完成 HLS 分级评测，官方数字见 [9-18 HLS pass@5 冻结](../record/9-18-HLS-pass5-ranked-fences.md)。
