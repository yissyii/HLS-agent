...
def run(problem, output, *, config=None, run_id=None, manifest=None, policy=None,
        skills_dir=None, workflow_skills_dir=None, cpu_only=False, initial_source=None, raw_initial=False,
    ...
    try:
        ...
        workflow_skill_pack = WorkflowSkills(selected_policy, workflow_skills_dir)
        ...
        return solve(task, runtime, selected_policy, model or ModelClient(),
                     ...
                     initial_validation=known_validation, workflow_skills=workflow_skill_pack)
...
def main():
    ...
    parser.add_argument('--workflow-skills-dir', help='Frozen root containing enabled workflow Skill packages')
...
def _evaluate(args):
    try:
        code, receipt = run(args.problem, output_path(args.output), config=args.config, run_id=args.run_id,
                            ...
                            skills_dir=args.skills_dir, workflow_skills_dir=args.workflow_skills_dir,
                            cpu_only=args.cpu_only, rag_runtime=args.rag_runtime,
